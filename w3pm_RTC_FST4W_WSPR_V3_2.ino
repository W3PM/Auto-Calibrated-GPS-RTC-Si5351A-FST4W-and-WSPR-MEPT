/*
  ...
  19 April 2022     v2   Improved ulti-mode multi-band scheduling 
   ...
   8 July 2023      V3   Incorporated Gaussian pulse shaping  

  28 July 2023      V3_1 Now uses calibrated FST4W calibrated symbol timing              
...
/*
  ...
  (-1,-1,-1),  // End of schedule flag DO NOT DELETE
  };
*/
...
unsigned long XtalFreq = 25000000, tcount = 2, time_now = 0, LEDtimer, mult = 0, TXoffset = 1500, GaussianTime;
...
unsigned long WSPR_SymbolLength = 683;
